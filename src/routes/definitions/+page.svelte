<script lang="ts">
	...
	import { fetchChangeSource, fetchCreateSource, fetchDeleteSource, fetchSourceById, fetchSourcePage, fetchSourcePageCount, type CreateSourceRequest } from '$api/sources';
