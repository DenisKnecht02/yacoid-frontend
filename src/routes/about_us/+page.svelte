	...
	<div class="flex flex-col h-full w-full justify-center items-center gap-16 p-8">
			...
			<div class="flex w-2/3 lg:mx-6">
				...
				>
					...
					<p class="text-xl text-justify m-8">
						...
						<span class="text-xl font-mono">(February 2023)</span>
						we are completing the fifth semester in the field of computer science in the form of a dual
						study program at the
						<bold class="font-bold">Berlin School of Economics and Law</bold>. Further information
						on the university can be found
						<a class="link link-secondary" href="https://www.hwr-berlin.de/">here </a>
						.
					</p>
				</section>
			</div>
		...
		<div class="flex flex-col lg:flex-row w-full justify-around items-center gap-6 lg:gap-0">
			...
			<div class="flex w-2/3 lg:m-6">
				...
				>
					<p class="text-xl text-justify m-8">
						<bold class="font-bold">YACOID</bold> is an abbreviation for "<bold class="font-bold"
							>Y</bold
						>et
						<bold class="font-bold">A</bold>nother <bold class="font-bold">C</bold>ollection
						<bold class="font-bold">o</bold>f <bold class="font-bold">I</bold>ntelligent
						<bold class="font-bold">D</bold>efinitions". The project's aim is to provide scientific
						defintions according to all areas of intelligence. Researchers and interested people
						should easily access a collection of disambiguations. It was created as part of a study
						project at the University of Economics and Law.
					</p>
				</section>
			</div>
		</div>
